...
let past = events.filter(event => event.date < data.currentDate)
...
search.addEventListener('click', () => {
     let arrayFilterCheck = filterChecks(past)
...
checks.forEach(checkCategory => {
    checkCategory.addEventListener('change', () => {
        let arrayFilterText = searchText (texto.value, past)
